...
### Порядок сдачи
1. Создайте ветку для работы (например work), все коммиты выполняйте в неё
2. Создайте Pull Request из вашей ветки в ветку main вашего репозитория
3. Убедитесь, что Pull Request создан именно в вашем репозитории, а не в основном
4. Заполните гугл-форму и приложите ссылку на Pull Request
